...
import br.com.desafio.backend.common.GatewayException;
import br.com.desafio.backend.config.MensagemComponent;
import br.com.desafio.backend.entity.AccountPaymentEntity;
import br.com.desafio.backend.exchange.AccountPayExchange;
import br.com.desafio.backend.repository.AccountPaymentRepository;
...
public class AccountPaymentExchangeImpl implements AccountPayExchange {
    ...
    private void validateAccountPaymentEntity(AccountPaymentEntity accountPaymentEntity) {
        ...
        Preconditions.checkArgument(
                !(accountPaymentEntity.getStatus() == false && accountPaymentEntity.getPaymentDate() != null),
                statusErrorMessage
        );
